...
To be recognized on *the interwebs*, I had to make the first-ever purchase for this project: a domain name. Given that the school is called Södermalmsskolan,
