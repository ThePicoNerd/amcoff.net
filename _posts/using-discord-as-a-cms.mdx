...
We decided to photograph the food every day and display the images on a website. Since fancy storage solutions such as Amazon S3 and Google Cloud Storage exceeded the budget,
...
On top of that, the API used to interact with Discord is public and comes with [generous rate limits](https://discord.com/developers/docs/topics/rate-limits)!
...
<Warning>
  While I was a faithful customer of GoDaddy for several years and paid them
  hundreds of euros in domain fees, I wouldn't recommend them to anyone today.
  Namecheap proved to be much more economical and, frankly, cooler in every way
  possible. At the end of the day, the only feature of a domain registrar that I
  care about is how fast I can switch to some other nameservers. But now you all
  know there is a registrar named Namecheap, and that they saved me, in every
  way that a developer can be saved.
</Warning>

<Image src="/assets/potato.jpg" width={3036} height={4048} />
